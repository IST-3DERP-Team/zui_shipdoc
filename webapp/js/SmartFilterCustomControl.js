sap.ui.define([ 
	...
	return {
        ...
        setSmartFilterModel(oThis) {
            ...
            var me = oThis;
            var oModel = me.getOwnerComponent().getModel("ZVB_3DERP_SHIPDOC_FILTERS_CDS");               
            ...
            var oModelURI = new sap.ui.model.odata.v2.ODataModel("/sap/opu/odata/sap/ZVB_3DERP_SHIPDOC_FILTERS_CDS");
        ...
        onSmartFilterCustomControlValueHelp: function(oEvent) {
            ...
            this._oSmartFilterCustomControlValueHelpDialog = sap.ui.xmlfragment("zuishipdoc.view.fragments.valuehelp.SmartFilterCustomControlValueHelpDialog", this);
